...
import type { AJDecisionSnapshot } from "@/indicators/AJIndicator/debug/AJDecisionSnapshot";
	...
	const intelligentModeDecision =
        ...
        const optionResult =
            isOptionChart
                ? {
                    ...baseOptionResult,
                    optionSymbol: chartSymbol,
                    recommendedOption: chartSymbol,
                    optionType:
                        /CE$/i.test(chartSymbol)
                            ? "CE"
                            : "PE"
                }
                : baseOptionResult;
